...
import cn.com.weiSsm.service.DubboService;
...
public class SysUserController extends BaseController {
	...
	@RequestMapping(value = "/sysUser/dubbo")
	public void dubboTest(HttpServletRequest request,Model model){
		String ss=dubboService.dubbos("dubbo");
		System.out.print(ss);
	}
